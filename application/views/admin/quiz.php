     <div class="content">
	   <div>
      	<ol class="breadcrumb">
			<li>Quiz List<?php //echo $mainpagename1; ?></li>
		</ol>
	</div>
...
<div class="row clearfix">
	...
	<?php
		...
		$add_url=$this->config->item("base_url")."admin/gift/giftaddedit";
		//echo anchor($add_url, '<i class="fa fa-plus"></i>&nbsp; Add Gift', $stores_add_href_attribute);
		echo "&nbsp;";
	  ...
	  <!----<li class="col-md-2" style="vertical-align:top;">
		<form role="form2" id="form2" action="" method="post">
		    ...
		    <?php
				...
				$type[100] = 100;
				$type[200] = 200;
				echo form_dropdown('type', $type, $this->session->userdata('sv_giftpageid'), "id='type' class='pageTyp form-control' onchange='myPagination(this.value);' style='background:#eeeeee;'");****/
			?>
			</div>
		</form>
		<li>---->
...
?>
                ...
                <tr>
					...
					<td><?php echo $tmpdetails1['session_description'] ; ?></td>

					<!--<td><?php //echo ($tmpdetails1['session_summary_image']!='')?"<img src=".$tmpdetails1['session_summary_image']." width=40>":'';?></td>--->

					<td><a href="<?php echo $this->config->item('base_url').'admin/quiz/quizaddedit/'.$tmpdetails1['id']; ?>">Edit</a>
                </tr>
                <!--Table row END -->
<?php
		$i++;
...
function myPagination(getval){
	$.ajax({
		type: "POST",
		url: "<?php echo $this->config->item('base_url').'admin/gift/setpagination';?>",
		cache: false,
		data: 'pageid='+getval,
		datatype: "text",
