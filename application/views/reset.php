...
<?php if($this->session->flashdata('msg2')): ?>
    <p><?php echo $this->session->flashdata('msg2'); ?></p>
<?php endif; ?>
...
<div class="col-xs-12 paddingNone marginNone">
	...
	<?php }else{ ?>
		...
		<div class="row text-center">
			<a href="<?=$this->config->item('base_url')?>/Super@1" class="btn btn-primary btn-block loginBtn">Go to home</a>
		</div>
	<?php } ?>
...
function validOn(){
    ...
    if(reg1.test(password) == false){
	   ...
	   maincontent2.innerHTML = 'Password should contain at least 6 digit!.';
	   return false;
    }
