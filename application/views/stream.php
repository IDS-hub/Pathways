...
<!----->
    ...
    <script src="<?=$this->config->item('base_url')?>public/js1/vendor-bundle.js?v=2.1.0"></script>
    <script src="<?=$this->config->item('base_url')?>public/js1/AgoraRTCSDK-2.1.0.js"></script>
    <script src="<?=$this->config->item('base_url')?>public/js1/meeting.js?v=2.1.0"></script>
