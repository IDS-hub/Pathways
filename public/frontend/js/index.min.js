/**
 * Created by yuanlan on 2017/1/18.
 */
$(function () {
    var channel = mi.util.getQueryVal('channel', window.location.href),
        map = {
            apk: {
                ow: 'https://s1.zb.mi.com/miliao/apk/walilive/2.3/walilive-oversea2.0-meng_1336_2_android-release-2.3.219.apk',
                owm:'https://s1.zb.mi.com/miliao/apk/walilive/2.3/walilive-oversea2.0-meng_1336_2_android-release-2.3.219.apk',
                facebook: 'https://s1.zb.mi.com/miliao/apk/walilive/2.3/walilive-oversea2.0-meng_1336_2_android-release-2.3.219.apk',
                mc: 'https://s1.zb.mi.com/miliao/apk/walilive/2.2/walilive-2.2.f-meng_1254_26_android-release-2.2.200_p4.apk',
                mb: 'https://s1.zb.mi.com/miliao/apk/walilive/2.3/walilive-oversea2.0-meng_1336_3_android-release-2.3.219.apk',
                uc: 'https://s1.zb.mi.com/miliao/apk/walilive/2.3/walilive-oversea2.0-meng_1336_2_android-release-2.3.219.apk',
                vr: 'https://s1.zb.mi.com/miliao/apk/walilive/2.3/walilive-oversea2.0-meng_1336_2_android-release-2.3.219.apk',
                mbnewscard: 'https://s1.zb.mi.com/miliao/apk/walilive/2.3/walilive-oversea2.0-meng_1336_3_android-release-2.3.219.apk',
                mbsplash:'https://s1.zb.mi.com/miliao/apk/walilive/2.3/walilive-oversea2.0-meng_1336_2_android-release-2.3.219.apk',
                _default: 'https://s1.zb.mi.com/miliao/apk/walilive/2.3/walilive-oversea2.0-meng_1336_2_android-release-2.3.219.apk'
            },
            appstore: {
                ow: 'https://itunes.apple.com/app/apple-store/id1095089970?pt=118149375"&"&ct="&C2&"&mt=8​',
                owm:'https://itunes.apple.com/app/apple-store/id1095089970?pt=118149375"&"&ct="&C3&"&mt=8​',
                facebook: 'https://itunes.apple.com/app/apple-store/id1095089970?pt=118149375"&"&ct="&C4&"&mt=8​',
                mc: 'https://itunes.apple.com/app/apple-store/id1095089970?pt=118149375"&"&ct="&C5&"&mt=8​',
                mb: 'https://itunes.apple.com/app/apple-store/id1095089970?pt=118149375"&"&ct="&C6&"&mt=8​',
                uc: 'https://itunes.apple.com/app/apple-store/id1095089970?pt=118149375"&"&ct="&C7&"&mt=8​',
                vr: 'https://itunes.apple.com/app/apple-store/id1095089970?pt=118149375"&"&ct="&C8&"&mt=8​',
                mbnewscard: 'https://itunes.apple.com/app/apple-store/id1095089970?pt=118149375"&"&ct="&C9&"&mt=8​',
                mbsplash:'https://itunes.apple.com/app/apple-store/id1095089970?pt=118149375"&"&ct="&C10&"&mt=8​',
                _default: 'https://itunes.apple.com/app/apple-store/id1095089970?pt=118149375"&"&ct="&C2&"&mt=8​'
            },
            googplay: {
                ow: 'https://play.google.com/store/apps/details?id=com.wali.live&referrer=utm_source%3D"&C2&"%26utm_medium%3D"&D2&"%26utm_campaign%3D"&E2',
                owm:'https://play.google.com/store/apps/details?id=com.wali.live&referrer=utm_source%3D"&C3&"%26utm_medium%3D"&D3&"%26utm_campaign%3D"&E3​',
                facebook: 'https://play.google.com/store/apps/details?id=com.wali.live&referrer=utm_source%3D"&C4&"%26utm_medium%3D"&D4&"%26utm_campaign%3D"&E4​',
                mc: 'https://play.google.com/store/apps/details?id=com.wali.live&referrer=utm_source%3D"&C5&"%26utm_medium%3D"&D5&"%26utm_campaign%3D"&E5​',
                mb: 'https://play.google.com/store/apps/details?id=com.wali.live&referrer=utm_source%3D"&C6&"%26utm_medium%3D"&D6&"%26utm_campaign%3D"&E6',
                uc: 'https://play.google.com/store/apps/details?id=com.wali.live&referrer=utm_source%3D"&C7&"%26utm_medium%3D"&D7&"%26utm_campaign%3D"&E7',
                vr: 'https://play.google.com/store/apps/details?id=com.wali.live&referrer=utm_source%3D"&C8&"%26utm_medium%3D"&D8&"%26utm_campaign%3D"&E8',
                mbnewscard: 'https://play.google.com/store/apps/details?id=com.wali.live&referrer=utm_source%3D"&C9&"%26utm_medium%3D"&D9&"%26utm_campaign%3D"&E9',
                mbsplash:'https://play.google.com/store/apps/details?id=com.wali.live&referrer=utm_source%3D"&C10&"%26utm_medium%3D"&D10&"%26utm_campaign%3D"&E10',
                _default: 'https://play.google.com/store/apps/details?id=com.wali.live&referrer=utm_source%3D"&C2&"%26utm_medium%3D"&D2&"%26utm_campaign%3D"&E2'
            }
        },
        socialUrls = {
            facebook:"https://www.facebook.com/mi.live.in/",
            twitter:"https://twitter.com/MiliveOfficial",
            instagram:" https://www.instagram.com/milive.official/"
        };

    mi.util.sendStatistic({
        curpageid: 'live_download_action',
        type: 'live_show',
        fuid: 'show',
        cid: 'live_activity',
        trace:'en',
    ...
    function download(type){
        var url = map[type][channel] || map[type]['_default'];
        mi.util.sendStatistic({
            curpageid: 'live_download_action',
            type: 'live_download_pc',
            fuid: 'download_pc',
            cid: 'live_activity',
            position: type,
            trace:'en',
        ...
        ga('send',"event", "download_pc", type,channel);
        var w = window.open('_blank.json');
        w.location=url;
    }

    function goSocialUrl(type){
        mi.util.sendStatistic({
            curpageid: 'live_download_action',
            type: 'live_gosocial_pc',
            fuid: 'gosocial_pc',
            cid: 'live_activity',
            position:type,
            trace:'en',
        ...
        ga('send',"event", "gosocial_pc", type,channel);
        var w = window.open('_blank.json');
        w.location=socialUrls[type];
    }
    ...
    $('.instagram').on('click',function(){
        goSocialUrl("instagram");
    });

    $.fn.animateCss = function(t){
    ...
    function imageChange() {
        var $window = $(window),
            $bg = $(".bg"),
            per = 1920 / 1080;
        if($window.width() / $window.height() < per){
            //宽度较小的时候，以图片的高度作为100%，height: 100%，宽度自适应，即所需要的宽度是w = $window.height() * per
            // position: absolute;top: 0;left: 50%;"margin-left": -($window.height() * per) / 2
            $bg.removeClass("bgwidth")
                .addClass("bgheight")
                .css({
                    "margin-top": 0,
                    "margin-left": -($window.height() * per) / 2
                });
        }else{
            //高度较小的时候，以图片的宽度作为100%， width: 100%;高度自适应，即所需要的高度是h = $window.width() / per
            // position: absolute;top: 50%;top: 0;margin-top: -($window.width() / per) / 2,
            $bg.removeClass("bgheight")
                .addClass("bgwidth")
                .css({
                    "margin-top": -($window.width() / per) / 2,
                    "margin-left": 0
                });
        }
    }

    $(window).resize(imageChange).trigger("resize");

    $('#fullpage').fullpage({
        navigation: true,
        navigationPosition:'right',
        navigationColor:'#f1b300',
        verticalCentered: false,
        scrollingSpeed: 1e3,
        easingcss3: "cubic-bezier(.77,.43,.32,.9)",
        afterRender: function() {  //页面初始化完成后的回调函数
            $(".section1 .section-content").css("visibility", "visible");
            $(".logo-title,.title").animateCss("bounceInDownow");

        },
        afterLoad: function(t, n) {  //滚动到某一屏后的回调函数，接收 anchorLink 和 index 两个参数，anchorLink 是锚链接的名称，index 是序号，从1开始计算
            $(".section" + n).addClass("is-active");
            //$(".container-2").css("visibility", "visible");
            if(n!=5){
                $(".phone-icon").removeClass("icon-up-ani");
            }
            if(n!=6){
                $(".last-icon").removeClass("icon-change-Ani");
            }
        },
        onLeave: function(t, n) {//滚动前的回调函数，接收 index、nextIndex 和 direction 3个参数：index 是离开的“页面”的序号，从1开始计算；nextIndex 是滚动到的“页面”的序号，从1开始计算；direction 判断往上滚动还是往下滚动，值是 up 或 down。
            $(".section" + n).removeClass("is-active");

            if(n==6){
                $(".arrow-wrapper").hide();
                $(".section6-title").animateCss("bounceInDownow");
                $(".last-icon").addClass("icon-change-Ani");
            }
            ...
            if(n==2){
                $(".container-2").css("visibility", "visible");
                $(".arrow-wrapper").show();
                $(".section2-title").animateCss("fadeInRight");
                $(".l-ear,.r-ear").animateCss("shake");
                $(".section2-line1,.section2-line2").animateCss("fadeInRight");
            }

            if(n==3){
                $(".arrow-wrapper").show();
                $(".section3-title").animateCss("fadeInLeft");
                $(".section3-line1,.section3-line2,.section3-line3").animateCss("fadeInRight");
                $(".section3-dialog-1-li,.section3-dialog-2-li,.section3-dialog-3-li,.section3-dialog-4-li").animateCss("fadeInLeft");
            }

            if(n==4){
                $(".arrow-wrapper").show();
                $(".section4-title").animateCss("fadeInRight");
                $(".section4-line1,.section4-line2").animateCss("fadeInRight");
                $(".section4-dialog-1-li,.section4-dialog-2-li,.section4-dialog-3-li").animateCss("fadeInLeft");
            }

            if(n==5){
                $(".arrow-wrapper").show();
                $(".section5-title").animateCss("fadeInLeft");
                $(".section5-line1,.section5-line2").animateCss("fadeInLeft");
                $(".phone-icon").addClass("icon-up-ani");

            }
        },
        'navigationTooltips': ['LIVE EVERY MOMENT', 'Magic Emoji', 'Live Life Live', 'Stunning Gifts','Share','Follow us on']
    });
